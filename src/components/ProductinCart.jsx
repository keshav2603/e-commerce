...
import { removeItemIncart } from "../app/features/selectSlice";

export default function ProductinCart({ image, price, title, productId }) {
            ...
            <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                ...
                <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button className="h-5 w-5 cursor-pointer duration-150 hover:text-red-500" onClick={handleDelete}>
                            <RiDeleteBinLine />
                        </button>
                    </div>
                </div>
